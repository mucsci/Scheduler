...
`RoomConfig` and `LabConfig` are public configuration models. `DiagnosticEngine` and `ScheduleAuditor` are internal architectural components despite being importable from their
