...
| `pack_rooms` | Prefer different courses to use the same room when room-occupying physical meetings are adjacent. Online meetings and unreserved lab meetings do not count. |
