...
ids, delivery modality, required features, optional labs, and whether labs reserve the lecture room. Candidate and
...
for no-lab sections. A separately listed lab section receives its own row and capacity.
