...
- `conflicting_constraints`: one unsatisfiable business-rule core; `core_is_minimal` reports whether
  subset-minimality was proved within the configured check conditions.
- `alternative_conflict_sets`: other bounded cores that were subset-minimized within each completed search.
