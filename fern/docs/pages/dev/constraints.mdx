...
- Keep Z3 variables exclusively in `CourseVariables` inside solver artifacts. Normalized `Course` objects remain
  solver-independent. Each course section has at most one optional lab assignment.
