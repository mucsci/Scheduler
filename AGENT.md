...
- **User-facing docs site**: `fern/` (MDX + generated OpenAPI, schema, and ephemeral Python reference)
...
| Generate Python library reference | `fern docs md generate --local --library scheduler-python` |
