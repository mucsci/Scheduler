...
from day import Day
from time_slot import TimeSlot, Slot
    ...
    if credits == 3:
        ...
        for (h, m) in [(8, 0), (9, 0), (10, 0), (13, 10), (14, 10), (15, 10)]:
            ...
            for lab in [Day.TUE, Day.THU]:
                yield TimeSlot(Slot(Day.MON, h, 0, SHORT), Slot(lab, h, m, LONG), Slot(Day.FRI, h, 0, SHORT), lab_index=1)
                yield TimeSlot(Slot(Day.MON, h + 1, 0, SHORT), Slot(lab, h, m, LONG), Slot(Day.FRI, h + 1, 0, SHORT), lab_index=1)
        # W
        for (h, m) in [(8, 0), (9, 0), (10, 0), (11, 0), (12, 0), (13, 0)]:
            yield TimeSlot(Slot(Day.MON, h, 0, SHORT), Slot(Day.WED, h, m, LONG), Slot(Day.FRI, h, 0, SHORT), lab_index=1)
            yield TimeSlot(Slot(Day.MON, h + 1, 0, SHORT), Slot(Day.WED, h, m, LONG), Slot(Day.FRI, h + 1, 0, SHORT), lab_index=1)
        # evenings
